...
const OrderReceivedEmail = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === "development"
      ? "http://localhost:3000"
      : "https://casecobra-rosy.vercel.app";
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              ...
              your package has been shipped. Delivery usually takes 2-3 days.
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              If you have any questions regrading your order, please feel free
          ...
          <Hr style={global.hr} />
          <Section style={global.defaultPadding}>
            <Row style={{ display: "inline-flw", marginBottom: 40 }}>
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                Please contact us if you have any questions. (If your reply to
                this email, we won't be able to see it.)
              </Text>
            </Row>
            <Row>
              <Text style={footer.text}>© CaseCobra. All rights reserved.</Text>
            </Row>
          </Section>
        </Container>
      </Body>
